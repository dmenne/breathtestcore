...
#' coefficients and half-emptying time t50 with the Maes/Ghoos method; additional parameters 
#' should be extracted with \code{\link[=coef.breathtestfit]{coef}}.
#' 
...
#' of class \code{breathttestfit}  as generated by  \code{\link{nls_fit}}
#' or \code{\link{nlme_fit}}.
#' 
#' @param x Object of class \code{breathttestfit}
