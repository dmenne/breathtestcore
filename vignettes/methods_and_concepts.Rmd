...
If you must, you can use function [ComputeAndSaveWNFit](https://github.com/dmenne/d13cbreath/blob/master/R/ComputeAndSaveWNFit.R) in my legacy package `D13CBreath`. The function is a bit awkward to use because it has been written for an application with a tightly integrated database, but feel free to steal the code and run.
